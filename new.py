...
class FeedbackSystem:
    ...
    def send_feedback_email(name: str, email: str, rating: int, feedback: str):
        ...
        try:
            # Email configuration
            sender_email = "cravinsanjay22@gmail.com"  # Replace with your email
            sender_password = "gror taom ymiq dhat"  # Replace with your password
...
class RexaBot:
    ...
    def __init__(self):
        ...
        self.service_keywords = {
            ...
            'bank_info': ['about cgbank', 'bank information', 'bank details', 'show  cgbank', 
